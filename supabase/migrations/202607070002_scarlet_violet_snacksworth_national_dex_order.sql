-- Reorder the Snacksworth Legendaries sub-dex by National Dex number instead
-- of the Scarlet/Violet-exclusive/shared/group-quest grouping used when they
-- were first seeded.
...
values
  ...
  ('scarlet-violet-snacksworth', 791, '', 20), -- Solgaleo
  ('scarlet-violet-snacksworth', 792, '', 21), -- Lunala
  ('scarlet-violet-snacksworth', 800, '', 22), -- Necrozma
  ('scarlet-violet-snacksworth', 891, '', 23), -- Kubfu
  ('scarlet-violet-snacksworth', 896, '', 24), -- Glastrier
  ('scarlet-violet-snacksworth', 897, '', 25)  -- Spectrier
