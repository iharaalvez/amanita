...
export const GAME_LIST: readonly GameEntry[] = [
  ...
  { id: "gold-silver", name: "Gold / Silver", generation: 2, hasShinyCharm: false },
  { id: "crystal", name: "Crystal", generation: 2, hasShinyCharm: false },
  { id: "ruby-sapphire", name: "Ruby / Sapphire", generation: 3, hasShinyCharm: false },
  { id: "emerald", name: "Emerald", generation: 3, hasShinyCharm: false },
  { id: "firered-leafgreen", name: "FireRed / LeafGreen", generation: 3, hasShinyCharm: false },
  { id: "diamond-pearl", name: "Diamond / Pearl", generation: 4, hasShinyCharm: false },
  { id: "platinum", name: "Platinum", generation: 4, hasShinyCharm: false },
  { id: "heartgold-soulsilver", name: "HeartGold / SoulSilver", generation: 4, hasShinyCharm: false },
  { id: "black-white", name: "Black / White", generation: 5, hasShinyCharm: false },
  { id: "black2-white2", name: "Black 2 / White 2", generation: 5, hasShinyCharm: true },
  { id: "x-y", name: "X / Y", generation: 6, hasShinyCharm: true },
  { id: "oras", name: "Omega Ruby / Alpha Sapphire", generation: 6, hasShinyCharm: true },
  { id: "sun-moon", name: "Sun / Moon", generation: 7, hasShinyCharm: true },
  { id: "usum", name: "Ultra Sun / Ultra Moon", generation: 7, hasShinyCharm: true },
  { id: "swsh", name: "Sword / Shield", generation: 8, hasShinyCharm: true },
  { id: "bdsp", name: "Brilliant Diamond / Shining Pearl", generation: 8, hasShinyCharm: true },
  { id: "pla", name: "Legends: Arceus", generation: 8, hasShinyCharm: true },
  { id: "scarlet-violet", name: "Scarlet / Violet", generation: 9, hasShinyCharm: true },
  { id: "legends-za", name: "Legends: Z-A", generation: 9, hasShinyCharm: true },
] as const;
