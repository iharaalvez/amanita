...
export const VERSION_EXCLUSIVES: Record<string, VersionExclusives> = {
  ...
  "gold-silver": {
    ...
    exclusives: {
      ...
      Silver: [
        37, 38, 52, 53, 165, 166, 200, 223, 224, 225, 227, 231, 232,
      ],
    },
  },
  ...
  "diamond-pearl": {
    ...
    exclusives: {
      Diamond: [
        86, 87, 123, 198, 212, 246, 247, 248, 261, 262, 304, 305, 306, 352,
        408, 409, 430, 434, 435, 483,
      ],
      Pearl: [
        79, 80, 127, 199, 200, 228, 229, 234, 363, 364, 365, 371, 372, 373,
        410, 411, 429, 431, 432, 484,
      ],
    },
  },
  ...
  "x-y": {
    ...
    exclusives: {
      X: [
        120, 121, 228, 229, 304, 305, 306, 345, 346, 347, 348, 692, 693, 716,
      ],
  ...
  "sun-moon": {
    versions: ["Sun", "Moon"],
    exclusives: {
      Sun: [37, 38, 408, 409, 546, 547, 564, 565, 627, 628, 766, 776, 791, 794, 798],
      Moon: [27, 28, 410, 411, 548, 549, 566, 567, 629, 630, 765, 780, 792, 795, 797],
    },
  },
  ...
  usum: {
    ...
    exclusives: {
      "Ultra Sun": [
        37, 38, 228, 229, 243, 250, 381, 383, 483, 485, 546, 547, 622, 623,
        627, 628, 641, 643, 692, 693, 716, 766, 776, 791, 794, 798, 806,
      ],
      "Ultra Moon": [
        27, 28, 244, 249, 309, 310, 343, 344, 380, 382, 484, 486, 548, 549,
        629, 630, 642, 644, 690, 691, 717, 765, 780, 792, 795, 797, 805,
      ],
    },
  },
  ...
  swsh: {
    ...
    exclusives: {
      ...
      // Includes Isle of Armor and Crown Tundra DLC exclusives
      Shield: [
        77, 78, 140, 141, 214, 222, 246, 247, 248, 249, 270, 271, 272, 302,
        337, 380, 382, 443, 444, 445, 453, 454, 484, 577, 578, 579, 629, 630,
        642, 644, 682, 683, 690, 691, 704, 705, 706, 717, 765, 780, 792, 842,
        864, 875, 889,
      ],
    },
  },
  ...
  "scarlet-violet": {
    ...
    exclusives: {
      ...
      Scarlet: [
        37, 38, 207, 243, 244, 245, 246, 247, 248, 250, 381, 383, 408, 409,
        425, 426, 434, 435, 472, 633, 634, 635, 643, 690, 691, 765, 791, 845,
        874, 896, 984, 985, 986, 987, 988, 989, 1005, 1007, 1020, 1021,
      ],
      // Includes Teal Mask and Indigo Disk DLC exclusives
      Violet: [
        27, 28, 190, 200, 249, 316, 317, 371, 372, 373, 380, 382, 410, 411,
        424, 429, 638, 639, 640, 644, 692, 693, 766, 792, 875, 877, 885, 886,
        887, 897, 990, 991, 992, 993, 994, 995, 1006, 1008, 1022, 1023,
      ],
    },
  },
};
