...
export type DonutRecipeCategory =
  | "Shiny Hunting"
  | "Item Farming"
  | "Berry Farming"
  | "Story"
...
export const RECOMMENDED_DONUT_RECIPES: RecommendedDonutRecipe[] = [
  // User-found optimized recipes.
  {
    id: "budget-9-sweet-tanga",
    title: "Budget 9 Sweet",
    category: "Flavor Budget",
    description: "760 Sweet score with 8 Hyper Tanga berries.",
    ingredients: [{ berryId: "hyper-tanga-berry", count: 8 }],
  },
  {
    id: "budget-9-sour-kasib",
    title: "Budget 9 Sour",
    category: "Flavor Budget",
    description: "760 Sour score with 8 Hyper Kasib berries.",
    ingredients: [{ berryId: "hyper-kasib-berry", count: 8 }],
  },
  {
    id: "budget-9-spicy-coba",
    title: "Budget 9 Spicy",
    category: "Flavor Budget",
    description: "760 Spicy score with 8 Hyper Coba berries.",
    ingredients: [{ berryId: "hyper-coba-berry", count: 8 }],
  },
  {
    id: "budget-9-bitter-charti",
    title: "Budget 9 Bitter",
    category: "Flavor Budget",
    description: "760 Bitter score with 8 Hyper Charti berries.",
    ingredients: [{ berryId: "hyper-charti-berry", count: 8 }],
  },
  {
    id: "budget-9-fresh-payapa",
    title: "Budget 9 Fresh",
    category: "Flavor Budget",
    description: "760 Fresh score with 8 Hyper Payapa berries.",
    ingredients: [{ berryId: "hyper-payapa-berry", count: 8 }],
  },
  {
    id: "budget-8-sweet-haban",
    title: "Budget 8 Sweet",
    category: "Flavor Budget",
    description: "700+ Sweet score with 2 Hyper Tanga and 6 Hyper Haban.",
    ingredients: [
      { berryId: "hyper-tanga-berry", count: 2 },
      { berryId: "hyper-haban-berry", count: 6 },
    ],
  },
  {
    id: "budget-8-sour-roseli",
    title: "Budget 8 Sour",
    category: "Flavor Budget",
    description: "700+ Sour score with 2 Hyper Kasib and 6 Hyper Roseli.",
    ingredients: [
      { berryId: "hyper-kasib-berry", count: 2 },
      { berryId: "hyper-roseli-berry", count: 6 },
    ],
  },
  {
    id: "budget-8-spicy-chilan",
    title: "Budget 8 Spicy",
    category: "Flavor Budget",
    description: "700+ Spicy score with 2 Hyper Coba and 6 Hyper Chilan.",
    ingredients: [
      { berryId: "hyper-coba-berry", count: 2 },
      { berryId: "hyper-chilan-berry", count: 6 },
    ],
  },
  {
    id: "budget-8-bitter-babiri",
    title: "Budget 8 Bitter",
    category: "Flavor Budget",
    description: "700+ Bitter score with 2 Hyper Charti and 6 Hyper Babiri.",
    ingredients: [
      { berryId: "hyper-charti-berry", count: 2 },
      { berryId: "hyper-babiri-berry", count: 6 },
    ],
  },
  {
    id: "budget-8-fresh-colbur",
    title: "Budget 8 Fresh",
    category: "Flavor Budget",
    description: "700+ Fresh score with 2 Hyper Payapa and 6 Hyper Colbur.",
    ingredients: [
      { berryId: "hyper-payapa-berry", count: 2 },
      { berryId: "hyper-colbur-berry", count: 6 },
    ],
  },
  {
    id: "rainbow-budget-8-sweet-fresh",
    title: "Rainbow Budget 8 Sweet/Fresh",
    category: "Rainbow",
    description: "525+ rainbow combo for Sweet and Fresh.",
    ingredients: [
      { berryId: "hyper-haban-berry", count: 6 },
      { berryId: "hyper-payapa-berry", count: 1 },
      { berryId: "hyper-yache-berry", count: 1 },
    ],
  },
  {
    id: "rainbow-budget-8-sour-spicy",
    title: "Rainbow Budget 8 Sour/Spicy",
    category: "Rainbow",
    description: "525+ rainbow combo for Sour and Spicy.",
    ingredients: [
      { berryId: "hyper-roseli-berry", count: 6 },
      { berryId: "hyper-chilan-berry", count: 1 },
      { berryId: "hyper-grepa-berry", count: 1 },
    ],
  },
  {
    id: "rainbow-budget-8-sour-bitter",
    title: "Rainbow Budget 8 Sour/Bitter",
    category: "Rainbow",
    description: "525+ rainbow combo for Sour and Bitter.",
    ingredients: [
      { berryId: "hyper-babiri-berry", count: 6 },
      { berryId: "hyper-roseli-berry", count: 1 },
      { berryId: "hyper-wacan-berry", count: 1 },
    ],
  },
  {
    id: "rainbow-budget-7-sweet-sour",
    title: "Rainbow Budget 7 Sweet/Sour",
    category: "Rainbow",
    description: "420+ Sweet/Sour rainbow with equal Tanga and Kasib.",
    ingredients: [
  ...
  {
    id: "rainbow-tangaless-sweet-sour-haban-roseli",
    title: "Tanga-less Sweet/Sour",
    category: "Rainbow",
    description: "Sweet/Sour rainbow without Hyper Tanga.",
    ingredients: [
      { berryId: "hyper-haban-berry", count: 4 },
      { berryId: "hyper-roseli-berry", count: 2 },
      { berryId: "hyper-kasib-berry", count: 2 },
    ],
  },
  {
    id: "rainbow-tangaless-chople-shuca-babiri",
    title: "Tanga-less Chople/Shuca",
    category: "Rainbow",
    description: "Sweet/Sour rainbow using Chople and Shuca instead of Tanga.",
    ingredients: [
      { berryId: "hyper-chople-berry", count: 2 },
      { berryId: "hyper-haban-berry", count: 2 },
      { berryId: "hyper-shuca-berry", count: 2 },
      { berryId: "hyper-babiri-berry", count: 1 },
      { berryId: "hyper-kasib-berry", count: 1 },
    ],
  },
  {
    id: "rainbow-tangaless-chople-kelpsy",
    title: "Tanga-less Kelpsy Variant",
    category: "Rainbow",
    description: "Sweet/Sour rainbow using Kelpsy as the extra mixer.",
    ingredients: [
      { berryId: "hyper-chople-berry", count: 2 },
      { berryId: "hyper-haban-berry", count: 2 },
      { berryId: "hyper-kasib-berry", count: 2 },
      { berryId: "hyper-kelpsy-berry", count: 1 },
      { berryId: "hyper-roseli-berry", count: 1 },
    ],
  },
  {
    id: "rainbow-tangaless-chople-qualot",
    title: "Tanga-less Qualot Variant",
    category: "Rainbow",
    description: "Sweet/Sour rainbow using Qualot as the extra mixer.",
    ingredients: [
      { berryId: "hyper-chople-berry", count: 2 },
      { berryId: "hyper-haban-berry", count: 2 },
      { berryId: "hyper-kasib-berry", count: 2 },
      { berryId: "hyper-qualot-berry", count: 1 },
      { berryId: "hyper-roseli-berry", count: 1 },
    ],
  },
  {
    id: "rainbow-no-tanga-kasib-babiri-wacan",
    title: "No Tanga/Kasib Rainbow",
    category: "Rainbow",
    description:
      "Sweet/Sour rainbow that avoids both Hyper Tanga and Hyper Kasib.",
    ingredients: [
      { berryId: "hyper-haban-berry", count: 3 },
      { berryId: "hyper-roseli-berry", count: 2 },
      { berryId: "hyper-babiri-berry", count: 1 },
      { berryId: "hyper-chople-berry", count: 1 },
      { berryId: "hyper-wacan-berry", count: 1 },
    ],
  },
  {
    id: "rainbow-no-tanga-shuca-occa",
    title: "Tanga-less Shuca/Occa",
    category: "Rainbow",
    description: "Sweet/Sour rainbow using Shuca and Occa as mixers.",
    ingredients: [
      { berryId: "hyper-haban-berry", count: 2 },
      { berryId: "hyper-shuca-berry", count: 2 },
      { berryId: "hyper-chople-berry", count: 1 },
      { berryId: "hyper-kasib-berry", count: 1 },
      { berryId: "hyper-occa-berry", count: 1 },
      { berryId: "hyper-roseli-berry", count: 1 },
    ],
  },
  {
    id: "rainbow-max-cal-spicy-bitter",
    title: "Max Calories Spicy/Bitter",
    category: "Rainbow",
    description: "High-calorie rainbow donut for Spicy and Bitter.",
    ingredients: [
      { berryId: "hyper-chilan-berry", count: 4 },
  ...
  {
    id: "rainbow-max-cal-spicy-sour",
    title: "Max Calories Spicy/Sour",
    category: "Rainbow",
    description: "High-calorie rainbow donut for Spicy and Sour.",
    ingredients: [
      { berryId: "hyper-roseli-berry", count: 4 },
      { berryId: "hyper-chilan-berry", count: 2 },
      { berryId: "hyper-haban-berry", count: 1 },
      { berryId: "hyper-kasib-berry", count: 1 },
    ],
  },
  {
    id: "rainbow-max-cal-spicy-sweet",
    title: "Max Calories Spicy/Sweet",
    category: "Rainbow",
    description: "High-calorie rainbow donut for Spicy and Sweet.",
    ingredients: [
      { berryId: "hyper-tanga-berry", count: 4 },
      { berryId: "hyper-chilan-berry", count: 4 },
    ],
  ...
  {
    id: "rainbow-max-cal-spicy-fresh",
    title: "Max Calories Spicy/Fresh",
    category: "Rainbow",
    description: "High-calorie rainbow donut for Spicy and Fresh.",
    ingredients: [
  ...
  {
    id: "rainbow-max-cal-bitter-fresh",
    title: "Max Calories Bitter/Fresh",
    category: "Rainbow",
    description: "High-calorie rainbow donut for Bitter and Fresh.",
    ingredients: [
  ...
  {
    id: "rainbow-max-cal-bitter-sour",
    title: "Max Calories Bitter/Sour",
    category: "Rainbow",
    description: "High-calorie rainbow donut for Bitter and Sour.",
    ingredients: [
      { berryId: "hyper-babiri-berry", count: 4 },
      { berryId: "hyper-roseli-berry", count: 2 },
      { berryId: "hyper-charti-berry", count: 1 },
      { berryId: "hyper-haban-berry", count: 1 },
    ],
  },
  {
    id: "rainbow-max-cal-bitter-sweet",
    title: "Max Calories Bitter/Sweet",
    category: "Rainbow",
    description: "High-calorie rainbow donut for Bitter and Sweet.",
    ingredients: [
      { berryId: "hyper-tanga-berry", count: 4 },
      { berryId: "hyper-babiri-berry", count: 2 },
      { berryId: "hyper-charti-berry", count: 2 },
  ...
  {
    id: "rainbow-max-cal-sour-fresh",
    title: "Max Calories Sour/Fresh",
    category: "Rainbow",
    description: "High-calorie rainbow donut for Sour and Fresh.",
    ingredients: [
      { berryId: "hyper-colbur-berry", count: 4 },
      { berryId: "hyper-babiri-berry", count: 1 },
      { berryId: "hyper-charti-berry", count: 1 },
      { berryId: "hyper-haban-berry", count: 1 },
      { berryId: "hyper-roseli-berry", count: 1 },
  ...
  {
    id: "rainbow-max-cal-sour-sweet",
    title: "Max Calories Sour/Sweet",
    category: "Rainbow",
    description: "High-calorie rainbow donut for Sour and Sweet.",
    ingredients: [
      { berryId: "hyper-haban-berry", count: 4 },
      { berryId: "hyper-roseli-berry", count: 4 },
    ],
  ...
  {
    id: "rainbow-max-cal-sweet-fresh",
    title: "Max Calories Sweet/Fresh",
    category: "Rainbow",
    description: "High-calorie rainbow donut for Sweet and Fresh.",
    ingredients: [
      { berryId: "hyper-haban-berry", count: 4 },
      { berryId: "hyper-babiri-berry", count: 2 },
      { berryId: "hyper-colbur-berry", count: 1 },
      { berryId: "hyper-coba-berry", count: 1 },
    ],
  },
  // ── Shiny Hunting ───────────────────────────────────────────────────────
  {
